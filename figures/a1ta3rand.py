...
class FigureA1TA3RandomConflicts(Figure):
    ...
    def compute(self):
        # execute the scenario A1TA3 with random generation of conflict
        from scenarios.a1ta3 import Amalgam1ToAmalgam3RandomConflicts
        for p in self.probs:
            for i in self.x:
                scenario = Amalgam1ToAmalgam3RandomConflicts(self.prefix, size=i, prob_conflict = p)
    ...
    def plot(self):
        ...
        plt.savefig("outfigs/FigureExhaustiveRandomA1TA3.png")

    def print_cmd(self):
        print("## Figure for evaluating the impact of the frequency of conflicts | Amalgam1ToAmalgam3 scenario")
