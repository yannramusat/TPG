...
class PersonAddressScenarioRev(Scenario):
...
class PersonAddressScenarioPlainRev(PersonAddressScenarioRev):
    def __init__(self, prefix, size = 100, lstring = 5):
        # input schema
...
class PersonAddressScenarioSeparateIndexesRev(PersonAddressScenarioRev):
    def __init__(self, prefix, size = 100, lstring = 5):
        # input schema
        super().__init__(prefix, size, lstring)
...
class PersonAddressScenarioCDoverSIRev(PersonAddressScenarioSeparateIndexesRev):
    def __init__(self, prefix, size = 100, lstring = 5):
        # input schema
        super().__init__(prefix, size, lstring)
...
class PersonAddressScenarioCDoverPlainRev(PersonAddressScenarioPlainRev):
    def __init__(self, prefix, size = 100, lstring = 5):
        # input schema
        super().__init__(prefix, size, lstring)
