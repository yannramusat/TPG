...
if __name__ == "__main__":
    ...
    if showStats:
        ...
        print(f"{results_Sep_NI_RI=}")
        print(f"{results_Sep_NI=}")
        print(f"{results_Sep_RI=}")
        print(f"{results_Sep=}")
        print("# Plain implementation")
        print(f"{results_Plain_NI_RI=}")
        print(f"{results_Plain_NI=}")
        print(f"{results_Plain_RI=}")
        print(f"{results_Plain=}")
        print("# Conflict Detection over Separate indexes")
        print(f"{results_CDoverSI_NI_RI=}")
        print(f"{results_CDoverSI_NI=}")
        print(f"{results_CDoverSI_RI=}")
        print(f"{results_CDoverSI=}")
        print("# Conflict Detection over Plain")
        print(f"{results_CDoverPlain_NI_RI=}")
        print(f"{results_CDoverPlain_NI=}")
        print(f"{results_CDoverPlain_RI=}")
        print(f"{results_CDoverPlain=}")
